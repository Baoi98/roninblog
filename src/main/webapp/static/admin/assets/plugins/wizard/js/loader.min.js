...
(function () {
    ...
    (function (d) {
        function l(a, b) {
            var c, d, e, f, g, h, j, k, l, m, n = b && b.split("/"), o = i.map, p = o && o["*"] || {};
            if (a && a.charAt(0) === "." && b) {
                n = n.slice(0, n.length - 1), a = n.concat(a.split("/"));
                for (k = 0; k < a.length; k += 1) {
                    m = a[k];
                    if (m === ".") a.splice(k, 1), k -= 1; else if (m === "..") if (k !== 1 || a[2] !== ".." && a[0] !== "..") k > 0 && (a.splice(k - 1, 2), k -= 2); else break
                }
                a = a.join("/")
            }
            if ((n || p) && o) {
        ...
        e = function (a, b, c, e) {
            ...
            if (typeof c == "function") {
                ...
                for (n = 0; n < b.length; n += 1) {
                    l = q(b[n], e), i = l.f;
                    if (i === "require") s[n] = m(a); else if (i === "exports") s[n] = g[a] = {}, t = !0; else if (i === "module") f = s[n] = {
                        id: a,
                        uri: "",
                        exports: g[a],
                        config: r(a)
                    }; else if (g.hasOwnProperty(i) || h.hasOwnProperty(i)) s[n] = p(i); else if (l.p) l.p.load(l.n, m(e, !0), o(i), {}), s[n] = g[i]; else if (!j[i]) throw new Error(a + " missing " + i)
                }
                k = c.apply(g[a], s);
                if (a) if (f && f.exports !== d && f.exports !== g[a]) g[a] = f.exports; else if (k !== d || !t) g[a] = k
            } else a && (g[a] = c)
        }, a = b = f = function (a, b, c, g, h) {
            return typeof a == "string" ? p(q(a, b).f) : (a.splice || (i = a, b.splice ? (a = b, b = c, c = null) : a = d), b = b || function () {
            }, typeof c == "function" && (c = g, g = h), g ? e(d, a, b, c) : setTimeout(function () {
                e(d, a, b, c)
            }, 15), f)
        }, f.config = function (a) {
            return i = a, f
            ...
            return function () {
                !function (a) {
                    ...
                    b.prototype.checkPosition = function () {
                        ...
                        var b = a(document).height(), c = this.$window.scrollTop(), d = this.$element.offset(),
                            e = this.options.offset, f = e.bottom, g = e.top, h = "affix affix-top affix-bottom", i;
            ...
            return function () {
                !function (a) {
                    ...
                    a.fn.collapse = function (c) {
                        return this.each(function () {
                            var d = a(this), e = d.data("collapse"),
                    ...
                    b.prototype = {
                        constructor: b, refresh: function () {
                            ...
                            var a = this.$scrollElement.scrollTop() + this.options.offset,
                                ...
                                c = b - this.$scrollElement.height(), d = this.offsets, e = this.targets,
                                f = this.activeTarget, g;
                ...
                !function (a) {
                    ...
                    b.prototype = {
                        constructor: b, show: function () {
                            var b = this.element, c = b.closest("ul:not(.dropdown-menu)"), d = b.attr("data-target"), e,
                                f, g;
        ...
        c.prototype = {
            constructor: c, setState: function (a) {
                var b = a.is(":checked"), c = a.is(":disabled");
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("checkbox"), h = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, selectedItem: function () {
                var a = this.$selectedItem, c = {};
                if (a) {
                    var d = this.$selectedItem.text();
                    c = b.extend({text: d}, this.$selectedItem.data())
                ...
                var a = "li[data-selected=true]:first", b = this.$element.find(a);
                ...
                this.$selectedItem = b(a.target).parent(), this.$input.val(this.$selectedItem.text()).trigger("change", {synthetic: !0});
                ...
                e.text.length === 0 && (e = {text: d}), this.$element.trigger("changed", e)
            }
        }, b.fn.combobox = function (a, d) {
            var e, f = this.each(function () {
                var f = b(this), g = f.data("combobox"), h = typeof a == "object" && a;
        ...
        var b = a("jquery"), c = 22, d = function (a, c) {
        ...
        d.prototype = {
            constructor: d, renderColumns: function () {
                var a = this;
                ...
                this.$tbody.html(this.placeholderRowHTML(this.options.loadingHTML)), this.options.dataSource.data(this.options.dataOptions, function (c) {
                    var d = c.count === 1 ? a.options.itemText : a.options.itemsText, e = "";
                ...
                var d = this.options.dataOptions.sortDirection, e = this.options.dataOptions.sortProperty,
                    f = c.data("property");
                ...
                var a = this.$gridContainer.height(), b = this.$headerTable.outerHeight(),
                    c = this.$footerTable.outerHeight(), d = b + c;
                this.$stretchWrapper.height(a - d)
            }, setColumnWidths: function () {
                function e(e, f) {
                    if (e === d - 1) return;
                    var g = b(f), h = a.eq(e), i = h.width();
                    h.hasClass("sorted") && g.prop("tagName") === "TD" && (i = i + c), g.width(i)
                }

                if (!this.$sizingHeader) return;
                this.$element.prepend(this.$sizingHeader);
                var a = this.$sizingHeader.find("th"), d = a.length;
                this.$colheader.find("th").each(e), this.$tbody.find("tr:first > td").each(e), this.$sizingHeader.detach()
            }
        }, b.fn.datagrid = function (a) {
            return this.each(function () {
                var c = b(this), e = c.data("datagrid"), f = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, items: function () {
                return this.$element.find("li").map(function () {
                    var a = b(this);
                    return b.extend({text: a.text()}, a.data())
                }).get()
            }, itemclicked: function (a) {
            ...
            var d, e = this.each(function () {
                var e = b(this), f = e.data("pillbox"), g = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, setState: function (a, b) {
                var c = a.is(":checked"), d = a.is(":disabled");
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("radio"), h = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, search: function (a) {
                ...
                var a = this.$input.val(), b = a === "" || a === this.activeSearch;
            ...
            return this.each(function () {
                var d = b(this), e = d.data("search"), f = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, render: function () {
                ...
                var b = this.options.value, c = a ? this.options.max : this.options.min;
                if (a ? b < c : b > c) {
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("spinner"), h = typeof a == "object" && a;
        ...
        c.prototype = {
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("select"), h = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, render: function () {
                ...
                var c = this, d = a.parent().find(".tree-loader:eq(0)");
                ...
                var c = b(a), d = this.$element.find(".tree-selected"), e = [];
                ...
                var a = this.$element.find(".tree-selected"), c = [];
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("tree"), h = typeof a == "object" && a;
        ...
        c.prototype = {
            constructor: c, setState: function () {
                var a = this.currentStep > 1, c = this.currentStep === 1, d = this.currentStep === this.numSteps;
                ...
                this.$element.trigger(e, {step: d + 1});
                ...
                if (a) {
                    ...
                    this.$element.trigger(c, {step: this.currentStep, direction: "previous"});
                    if (c.isDefaultPrevented()) return;
                ...
                if (a) {
                    ...
                    this.$element.trigger(d, {step: this.currentStep, direction: "next"});
                    if (d.isDefaultPrevented()) return;
                    this.currentStep += 1, this.setState()
            ...
            var e, f = this.each(function () {
                var f = b(this), g = f.data("wizard"), h = typeof a == "object" && a;
        ...
        return jQuery
    }), c("fuelux/loader", ["fuelux/all"], function () {
    }), b("fuelux/loader")
})();